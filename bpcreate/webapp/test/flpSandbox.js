		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BP Create",
									"targetURL": "#combpbpcreate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combpbpcreate-display": {
								"semanticObject": "combpbpcreate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bp.bpcreate",
									"url": sap.ui.require.toUrl("com/bp/bpcreate")
								}
							}
						}
					}
